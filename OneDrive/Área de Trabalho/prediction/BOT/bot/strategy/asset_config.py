...
class Asset:
    ...
    entry_delay: int            # skip-first-hour minutes after OR close (F38)
...
ASSETS = {
    "NQ":  Asset("NQ",  True,  20.0, 0.50, 60, sessions=_FUT3, options_root=None, status="validated"),
    "MNQ": Asset("MNQ", True,   2.0, 0.50, 60, sessions=_FUT3, options_root=None, status="validated"),
    "ES":  Asset("ES",  True,  50.0, 0.50, 60, sessions=_FUT3, options_root=None, status="validated"),
    "QQQ": Asset("QQQ", False,  1.0, 0.75, 60, sessions=(RTH_EQ,), options_root="QQQ", status="validated"),
    "SPY": Asset("SPY", False,  1.0, 0.75, 60, sessions=(RTH_EQ,), options_root="SPY", status="validated"),
    "GC":  Asset("GC",  True, 100.0, 0.50, 0,  sessions=(RTH_FUT,), options_root="GLD", status="unverified",
...
DEFAULT = Asset("?", False, 1.0, 0.75, 60, sessions=(RTH_EQ,), status="unverified", note="no per-asset config")
