...
> **PROMOTED:** `HIGHSTRIKE_ORB_STACK.pine` graduated and was **moved to `production/`** as the **primary indicator** —
> it merges + supersedes STRUCTURE + ASIA below and adds London + the graduated structure-stop/trail. The two files
> below remain here for reference only.
